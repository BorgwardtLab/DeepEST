...
The implementation of DeepEST is available under _train_model/_. The data to test the implementation is available with the release. Once the folder data has been places into _train_model/_, you can use the following command to train the model:
